...
Anchor: `core.extension-integrity`
...
Load-bearing rules defined by this file carry stable anchors: `core.product-thesis`, `core.system-layers`, `core.interaction-shapes`, `core.substrate-services`, `core.workspace-model`, `core.canonical-abstractions`, `core.artifact`, `core.evidence`, `core.current-major-area-classification`, `core.primitive-set`, `core.execution-ledger`, `core.world-model`, `core.settings-system`, `core.typed-errors`, `core.versioned-durable-state`, `core.projection`, `core.extension-planes`, `core.canonical-encoding`, `core.closed-canonical`, `core.invariants`, `core.durable-history-transient-coordination`, `core.typed-configuration-failure`, `core.local-extensibility`, `core.extension-integrity`, `core.evidence-provenance`, `core.non-destructive-by-default`, `core.canonical-hash`, `core.event-first-by-default`, `core.canonical-decode`, `core.data-locality`, and `core.stack-commitments`. Cross-references should prefer the anchor and may cite the section number secondarily. An anchor names exactly one canonical rule and is stable across spec revisions.
