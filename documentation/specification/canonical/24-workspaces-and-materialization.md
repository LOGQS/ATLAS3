...
This file declares what a workspace export contains and that it rides File 21. File 21 owns the package format, the blob transport, the import-pipeline stages, and egress governance; File 22 owns the secret boundary and the egress policy; File 09 owns the artifact identity preserved across export.
